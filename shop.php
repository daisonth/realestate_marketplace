    ...
    <div class="row">
      ...
      <div class="col-12 col-sm-6 col-md-12 col-xl-6">
        <div class="single-product-wrapper">
          ...
          <div class="product-img">
            <img src="img/product-img/plot1.jpg" alt="">
            <!-- Hover Thumb -->
            <img class="hover-img" src="img/product-img/plot2.jpg
                                " alt="">
          </div>
      ...
      <div class="col-12 col-sm-6 col-md-12 col-xl-6">
        <div class="single-product-wrapper">
          <!-- Product Image -->
          <div class="product-img">
            <img src="img/product-img/plot.jpg" alt="">
            <!-- Hover Thumb -->
            <img class="hover-img" src="img/product-img/plot3.jpg" alt="">
          </div>
