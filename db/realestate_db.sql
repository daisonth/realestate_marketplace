...
--
-- Host: localhost
-- Generation Time: Apr 17, 2023 at 09:10 PM
...
(33, 'Properties In Mumbai', 'See listings in Mumbai', '../img/home/2mumbai.jpg', 'shop.php?property-type=all&fileter-city=817&fileter-state=all&submit=Search'),
(35, 'Premium Houses', 'Buy Premium Houses', '../img/home/3lux_houses.jpg', 'shop.php?property-type=6&fileter-city=all&fileter-state=all&submit=Search'),
(36, 'Appartments', 'Buy Appartments', '../img/home/4room.jpg', 'shop.php?property-type=10&fileter-city=all&fileter-state=all&submit=Search'),
(38, 'Houses for sale', 'See all listed Houses', '../img/home/5house_1.jpg', 'shop.php?property-type=6&fileter-city=all&fileter-state=all&submit=Search'),
(40, 'Properties in Kerala', 'Buy from the best properties in Kerala', '../img/home/6kerala.jpg', 'shop.php?property-type=all&fileter-city=all&fileter-state=18&submit=Search'),
(41, 'Plot for sale', 'See all plots listed for sale', '../img/home/7plot.jpg', 'shop.php?property-type=11&fileter-city=all&fileter-state=all&submit=Search'),
...
ALTER TABLE `property_tbl`
  ...
  ADD KEY `fk_property_type` (`property_type`),
...
ALTER TABLE `users_tbl`
  ...
  ADD KEY `fk_users_city` (`city`),
  ADD KEY `fk_users_state` (`state`);
...
--
ALTER TABLE `wishlist_tbl`
  MODIFY `wishlist_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=57;
...
--
ALTER TABLE `property_tbl`
  ADD CONSTRAINT `fk_city` FOREIGN KEY (`city`) REFERENCES `city_tbl` (`city_id`),
  ADD CONSTRAINT `fk_owner` FOREIGN KEY (`owner_id`) REFERENCES `users_tbl` (`userid`),
  ADD CONSTRAINT `fk_property_type` FOREIGN KEY (`property_type`) REFERENCES `category_tbl` (`category_id`);

--
-- Constraints for table `users_tbl`
--
ALTER TABLE `users_tbl`
  ADD CONSTRAINT `fk_users_city` FOREIGN KEY (`city`) REFERENCES `city_tbl` (`city_id`),
  ADD CONSTRAINT `fk_users_state` FOREIGN KEY (`state`) REFERENCES `state_tbl` (`state_id`);

--
-- Constraints for table `wishlist_tbl`
--
ALTER TABLE `wishlist_tbl`
  ADD CONSTRAINT `fk_property_id` FOREIGN KEY (`property_id`) REFERENCES `property_tbl` (`property_id`),
  ADD CONSTRAINT `fk_user_id` FOREIGN KEY (`user_id`) REFERENCES `users_tbl` (`userid`);
COMMIT;
